...
model_names = ['NB', 'KNN', 'LR', 'PLS', 'SVM', 'RF', 'MLP', 'DT', 'ET', 'XGB']

with open('./output_csvs/model_wise_benchmark_results.csv', 'w') as f1, open('./output_csvs/Benchmark_results.csv', 'w') as f2, open('./output_csvs/Iteration_wise_benchmark_results.csv', 'w') as f3:
    ...
    Benchmark_results_csv.writerow(['Learner', 'Feature', 'Sensitivity', 'Specificity', 'Balanced Accuracy', 'Accuracy', 'Precision', 'F1-score', 'MCC', 'auROC', 'auPR'])
    Iteration_wise_benchmark_results_csv.writerow(['Learner', 'Feature', 'Iteration'])
    ...
    for model_name in model_names:
        ...
        for feature in features:
            ...
            for train_index, test_index in cv.split(X, y):
                ...
                Iteration_wise_benchmark_results_csv.writerow([model_name, feature, i])
            ...
            Benchmark_results_csv.writerow([model_name, feature, '{0:.4f}'.format(np.mean(local_Sensitivity)), '{0:.4f}'.format(np.mean(local_Specificity)), '{0:.4f}'.format(np.mean(local_Balanced_acc)), '{0:.4f}'.format(np.mean(local_Accuracy)),
