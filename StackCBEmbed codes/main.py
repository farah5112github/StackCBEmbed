...
def main():
    ...
    total_input, all_seq_code, folder_path, choice = sequence_processing(total_input, all_seq_code, folder_path);
    ...
    for i in range(0,len(all_seq_code)):
        ...
        if (choice == 1):
            ...
            converted_all_features_with_output = X_3.copy();
        ...
        y_pred = load_the_pickle_files_meta_layer(test_meta_layer_with_output_total, folder_path, choice);
