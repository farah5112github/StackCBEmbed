...
def sequence_processing(total_input, total_output, all_seq_code, folder_path):
    ...
    print('please enter the absolute path of the StackCBEmbed folder. For example, C:/Users/quazi/Desktop/StackCBEmbed/');
    folder_path = input();
    fasta_file_path = folder_path + 'input_files/' + 'input.txt';

    print('please enter a choice: 0 or 1. 0= model (embedding only) and 1= model (embedding and PSSM)');
    choice = int( input() );
