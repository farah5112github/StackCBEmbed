...
def sequence_processing(total_input, total_output, all_seq_code, folder_path):
    ...
    print('please enter the absolute path of the folder containing StackCBEmbed folder. For example, C:/Users/quazi/Desktop/StackCBEmbed/');
    folder_path = input();
    ...
    return total_input, total_output, all_seq_code, folder_path;