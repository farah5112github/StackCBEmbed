...
with open('./output_csvs/feature_wise_benchmark_results.csv', 'w') as f1, open('./output_csvs/Benchmark_results.csv', 'w') as f2, open('./output_csvs/Iteration_wise_benchmark_results.csv', 'w') as f3:
    ...
    for feature in features:
        ...
        all_model_name = ['NB', 'KNN', 'LR', 'PLS', 'SVM', 'RF', 'MLP', 'DT', 'ET', 'XGB']
        ...
        for model_name in all_model_name:
            ...
            for train_index, test_index in cv.split(X, y):
                ...
                Iteration_wise_benchmark_results_csv.writerow([feature, model_name, i])
            ...
            Benchmark_results_csv.writerow([feature, model_name, '{0:.4f}'.format(np.mean(local_Sensitivity)), '{0:.4f}'.format(np.mean(local_Specificity)), '{0:.4f}'.format(np.mean(local_Balanced_acc)), '{0:.4f}'.format(np.mean(local_Accuracy)),
