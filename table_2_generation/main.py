...
with open('./output_csvs/language_model_wise_benchmark_results.csv', 'w') as f1, open('./output_csvs/Benchmark_results.csv', 'w') as f2, open('./output_csvs/Iteration_wise_benchmark_results.csv', 'w') as f3:
    ...
    language_model_wise_benchmark_results_csv.writerow(['Language Model', 'Sensitivity', 'Specificity', 'Balanced Accuracy', 'Accuracy', 'Precision', 'F1-score', 'MCC', 'auROC', 'auPR'])
    Benchmark_results_csv.writerow(['Language Model', 'Classifier', 'Sensitivity', 'Specificity', 'Balanced Accuracy', 'Accuracy', 'Precision', 'F1-score', 'MCC', 'auROC', 'auPR'])
    Iteration_wise_benchmark_results_csv.writerow(['Language Model', 'Classifier', 'Iteration'])
    ...
    for embedding in embeddings:
        ...
        for model_name in all_model_name:
            ...
            for train_index, test_index in cv.split(X, y):
                ...
                Iteration_wise_benchmark_results_csv.writerow([embedding, model_name, i])
            ...
            Benchmark_results_csv.writerow([embedding, model_name, '{0:.4f}'.format(np.mean(local_Sensitivity)),'{0:.4f}'.format(np.mean(local_Specificity)),'{0:.4f}'.format(np.mean(local_Balanced_acc)), '{0:.4f}'.format(np.mean(local_Accuracy)),
