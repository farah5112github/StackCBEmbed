...
def seperate_the_data_sets_into_lists(file_path):
    ...
    with open(file_path,'r') as f:
        ...
        for i in range(1,len(lines),3):
            ...
            total_output.append(lines[i+1].strip())
...
def sequence_processing():
    ...
    total_input, total_output = seperate_the_data_sets_into_lists(fasta_file_path)
    ...
    return total_input, total_output, all_seq_code, choice
